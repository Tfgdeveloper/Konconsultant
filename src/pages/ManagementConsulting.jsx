...
const ManagementConsulting = () => {
  return (
    <div>
      {/* Hero */}
      <section className="w-full px-[0px] md:px-[100px] pt-[130px] bg-[url('/images/Hero.png')] bg-cover bg-center mt-[-80px]">
          ...
          <div className='relative w-full flex flex-col md:flex-row justify-between items-center gap-[20px]'>
            <div className='relative md:w-1/2 flex flex-col gap-[20px] justify-center items-start md:px-0 px-[20px] pb-0 md:pb-[75px] z-0 '>
              ...
              <p className='md:w-[462px] intertext text-[16px] tracking-[-0.48px] md:text-[18px] md:tracking-[-0.54px] text-black/60'>
                Unlock your business's full potential by addressing challenges and seizing new opportunities with consultants dedicated to protecting and enhancing your organizational value.
              </p>
               <Link to="/packages" className='order-2 intertext px-[20px] py-[10px] bg-[#4A68FE] rounded-full text-white shadow-[inset_3px_3px_4px_0_rgba(255,255,255,0.30)] font-medium text-[18px] hover:scale-110 transition tracking-[-0.72px]'>
                    Check our Packages
            ...
            <img src='images/innerservices.png' className='hidden md:flex absolute top-5 right-0 h-auto w-[620px] z-0'/>
      ...
      <section className='w-full px-[20px] md:px-[100px] '>
        ...
        <span className='intertext  text-[26px] md:text-[40px] tracking-[-1.82px] md:tracking-[-2.8px] text-black font-medium md:w-[800px] leading-[33px] md:leading-[45px]'>
          Work with experts who bring deep industry 
          knowledge, functional experience, and 
          technical expertise to meet your project needs.
        </span>
        <div className='w-full flex flex-col md:flex-row gap-[25px]'>
            ...
            shadow-[3px_3px_4px_0_rgba(255,255,255,0.30)_inset,-3px_-3px_4px_0_rgba(129,129,129,0.50)_inset,-81px_81px_162px_0_rgba(129,129,129,0.10),81px_-81px_162px_0_rgba(129,129,129,0.10)]'>
              ...
              <h4 className='intertext text-black text-[22px] tracking-[-1.54px] leading-[28.6px] font-medium'>
            ...
            shadow-[3px_3px_4px_0_rgba(255,255,255,0.30)_inset,-3px_-3px_4px_0_rgba(129,129,129,0.50)_inset,-81px_81px_162px_0_rgba(129,129,129,0.10),81px_-81px_162px_0_rgba(129,129,129,0.10)]'>
              ...
              <h4 className='intertext text-black text-[22px] tracking-[-1.54px] leading-[28.6px] font-medium'>
                 Services that create additional value
              </h4>
            ...
            shadow-[3px_3px_4px_0_rgba(255,255,255,0.30)_inset,-3px_-3px_4px_0_rgba(129,129,129,0.50)_inset,-81px_81px_162px_0_rgba(129,129,129,0.10),81px_-81px_162px_0_rgba(129,129,129,0.10)]'>
              ...
              <h4 className='intertext text-black text-[22px] tracking-[-1.54px] leading-[28.6px] font-medium'>
                 Assessing changes, adapting quickly
              </h4>
