  ...
  return (
    <div >
        ...
        <div className='w-full h-full mx-auto max-w-[1440px] flex flex-col justify-between items-center '>
          <div className='w-full bg-[#4A68FE] rounded-[17px] flex flex-col md:flex-row justify-between items-center p-[30px] gap-[30px]'>
            <div className='md:w-1/3 flex flex-col items-center gap-[20px]'>
              ...
              <span className=' text-[26px] tracking-[-1.82px] md:text-[36px] text-white md:tracking-[-2.52px] font-normal'>Strategy</span>
            </div>
            <div className='md:w-1/3 flex flex-col items-center gap-[20px]'>
              <img src="images/Group 2.png" className=''/>
              <span className=' text-[26px] tracking-[-1.82px] md:text-[36px] text-white md:tracking-[-2.52px]font-normal'>Validation</span>
            </div>
            <div className='md:w-1/3 flex flex-col items-center gap-[20px]'>
              <img src="images/Group 3.png" className=''/>
              <span className=' text-[26px] tracking-[-1.82px] md:text-[36px] text-white md:tracking-[-2.52px] font-normal'>Execution</span>
            </div>
      ...
      <section id="about" className='w-full px-[20px] md:px-[100px] '>
        ...
        <h2 className='  text-[32px] md:text-[56px] tracking-[-2.24px] md:tracking-[-3.92px] text-black font-medium'>
        ...
        <div className='h-full flex flex-col md:flex-row justify-end md:justify-between items-end gap-[10px] md:gap-[20px]'>
          <p className='order-2 md:order-1  text-[16px] md:text-[24px] tracking-[-1.12px] md:tracking-[-1.68px] text-white md:leading-[31.2px] w-full md:w-[800px]'>
          ...
          <div className='w-full md:w-auto flex flex-col gap-0 order-1 md:order-2'>
            <span className=' font-medium text-[34px] md:text-[44px] tracking-[-2.38px] md:tracking-[-2.8px] text-white leading-[42px] md:text-right'>
            09
            </span>
            <span className=' text-[20px] md:text-[24px] tracking-[-1.4px] md:tracking-[-1.68px] text-white'>
            years of expertise
            </span>
          </div>
      ...
      <section id="services" className="w-full px-[20px] md:px-[100px] py-[75px] w-full relative bg-[url('/images/servicesbg.png')] bg-cover bg-center">
        <div className='w-full mx-auto max-w-[1440px] flex flex-col justify-center items-center gap-[50px]'>
           <h2 className='  text-[32px] md:text-[56px] tracking-[-2.24px] md:tracking-[-3.92px] text-white font-medium'>
            Services we offer
          </h2>
          <div className='w-full flex flex-col md:flex-row gap-[25px]'>
            ...
            shadow-[3px_3px_4px_0_rgba(255,255,255,0.30)_inset,-3px_-3px_4px_0_rgba(129,129,129,0.50)_inset,-81px_81px_162px_0_rgba(129,129,129,0.20),81px_-81px_162px_0_rgba(129,129,129,0.20)]'>
              <div className='w-full flex justify-center items-center md:mb-[28px] mb-[15px]'>
                <img src='images/Online consulting-rafiki 2.png' className='w-auto md:h-[186px] h-[130px]'/>
              </div>
              
              <div className='w-full flex flex-col gap-[10px]'>
                <h4 className=' text-black text-[26px] tracking-[-1.82px] leading-[33.8px] font-medium'>
                  Management Consulting
                </h4>
                <p className='w-[303px]  text-black/60 text-[18px] tracking-[-0.54px]'>
            ...
            shadow-[3px_3px_4px_0_rgba(255,255,255,0.30)_inset,-3px_-3px_4px_0_rgba(129,129,129,0.50)_inset,-81px_81px_162px_0_rgba(129,129,129,0.20),81px_-81px_162px_0_rgba(129,129,129,0.20)]'>
              <div className='w-full flex justify-center items-center md:mb-[28px] mb-[15px]'>
                <img src='images/Investment data-rafiki 2.png' className='w-[383.138px] md:h-[186px] h-[130px]'/>
              </div>
              <div className='w-full flex flex-col gap-[10px]'>
                <h4 className=' text-black text-[26px] tracking-[-1.82px] leading-[33.8px] font-medium'>
                  Assurance
                </h4>
                <p className='w-[320px]  text-black/60 text-[18px] tracking-[-0.54px]'>
            ...
            shadow-[3px_3px_4px_0_rgba(255,255,255,0.30)_inset,-3px_-3px_4px_0_rgba(129,129,129,0.50)_inset,-81px_81px_162px_0_rgba(129,129,129,0.20),81px_-81px_162px_0_rgba(129,129,129,0.20)]'>
              ...
              <div className='w-full flex justify-center items-center md:mb-[28px] mb-[15px]'>
                <img src='images/Finance-rafiki 2.png' className='w-auto md:h-[186px] h-[130px]'/>
              </div>
              <div className='w-full flex flex-col gap-[10px]'>
                <h4 className=' text-black text-[26px] tracking-[-1.82px] leading-[33.8px] font-medium'>
                  Risk Advisory
                </h4>
                <p className=' text-black/60 text-[18px] tracking-[-0.54px]'>
          ...
          <button className='order-2  px-[20px] py-[10px]  
      ...
      <section id="packages" className='w-full px-[20px] md:px-[100px] overflow-hidden '>
        ...
        <h2 className='hidden md:block   text-center text-[32px] md:text-[56px] tracking-[-2.24px] md:tracking-[-3.92px] text-black font-medium'>
         Our <span className='text-[#4A68FE]'>Industry</span> Specialization
        </h2>
        <h2 className='md:hidden  text-center text-[32px] md:text-[56px] tracking-[-2.24px] md:tracking-[-3.92px] text-black font-medium leading-[45px]'>
         Our <span className='text-[#4A68FE]'>Industry</span> <br/>Specialization
        </h2>
        <p className='md:w-[646px]  md:text-[18px] md:tracking-[-0.54px] text-[16px] tracking-[-0.48px] text-black/60 text-center'>
